...
library(e1071)
pca = preProcess(x = training_set[-5], method = 'pca', pcaComp = 2)
training_set = predict(pca, training_set)
training_set = training_set[c(2, 3, 1)]
#After pca,dependent variable first comes first in dataset so here v r rearranging it.
...
#Accuracy for Principal component Analysis = 78 %
